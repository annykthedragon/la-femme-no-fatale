<%@ Page Title="la femme fatale | СТАТЬИ" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Article-3_NoMarriage.aspx.cs" Inherits="la_femme_no_fatale.Article_3_NoMarriage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="home-container" style="width: 1000px; height: 1900px; padding: 20px; padding-top: 40px;">
        ...
        <section>
            <div class="container">
                <h1 style="color: #CC3300; line-height: 50px">Крушение института брака</h1>
                <h2 style="text-align: left">Почему я не хочу выходить замуж (вообще)?
                </h2>
            </div>
        </section>
