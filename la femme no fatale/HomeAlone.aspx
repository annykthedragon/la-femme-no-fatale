<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="HomeAlone.aspx.cs" Inherits="la_femme_no_fatale.HomeAlone" %>
                    ...
                    <div class="slide-wrapper">
                        <div class="slide" data-order="1">
                            ...
                            <div class="slide-content">
                                ...
                                <div class="slide-txt">
                                    <p>
                                        Читай статьи. Обсуждай. Статнь частью сообщества сильных женщин.
                                    </p>
                                    <button><a href="#popup1">Каталог статей</a></button>
                                </div>
                            </div>
                        </div>
                        <div class="slide" data-order="2">
                            ...
                            <div class="slide-content">
                                ...
                                <div class="slide-txt">
                                    ...
                                    <button><a href="#popup1">Авторство</a></button>
                                </div>
                            </div>
                        </div>
                        <div class="slide" data-order="3">
                            ...
                            <div class="slide-content">
                                ...
                                <div class="slide-txt">
                                    ...
                                    <button><a href="#popup1">Опросы</a></button>
                                </div>
                            </div>
                        </div>
                    </div>
