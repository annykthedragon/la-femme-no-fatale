...
{
    public partial class MakeForms : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (login != null && sign != null)
            {
                ...
                {*/
                    //подтверждение
                    string script = "return confirm('Отправить опрос модератору?');";
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                msg.Subject = "Опросы";
                msg.Body = "Пользователь la femme не fatale " + name + " хочет провести исследование: \n" + TextArea1.InnerText;
